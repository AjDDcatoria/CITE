<main class="h-dvh flex justify-center text-gray-500 p-5 overflow-auto bg-gray-100">
    <div class="max-w-[60rem] w-full h-fit shadow-lg px-5 py-8 rounded-lg border bg-white">
